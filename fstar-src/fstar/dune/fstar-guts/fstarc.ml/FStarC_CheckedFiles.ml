...
let (mcache : cache_t FStarC_SMap.smap) =
    ...
    fun fn ->
            ...
            (match uu___ with
             | FStar_Pervasives_Native.None ->
                 ...
                 ((let uu___2 = FStarC_Effect.op_Bang dbg in
                   if uu___2 then FStarC_Util.print1 "%s\n" msg else ());
      ...
      let rec hash_deps out uu___ =
        ...
        | fn2::deps1 ->
            ...
            let digest =
              let uu___1 = FStarC_SMap.try_find mcache cache_fn in
              match uu___1 with
              | FStar_Pervasives_Native.None ->
                  let msg =
                    FStarC_Util.format2

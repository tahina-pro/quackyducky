  ...
  fun uu___ ->
    let uu___1 =
      ...
      FStarC_List.map
        (fun uu___3 ->
           match uu___3 with
           | (k, r) -> let uu___4 = FStarC_Effect.op_Bang r in (k, uu___4))
        uu___2 in
...
let (register_toggle : Prims.string -> Prims.bool FStarC_Effect.ref) =
  fun k ->
    ...
    (let uu___2 =
       let uu___3 = FStarC_Effect.op_Bang toggle_list in (k, r) :: uu___3 in
  ...
  fun snapshot1 ->
    (let uu___1 = FStarC_Effect.op_Bang toggle_list in
     FStarC_List.iter
       (fun uu___2 ->
          match uu___2 with
          | (uu___3, r) -> FStarC_Effect.op_Colon_Equals r false) uu___1);
    FStarC_List.iter
      (fun uu___2 ->
         match uu___2 with
         | (k, b) ->

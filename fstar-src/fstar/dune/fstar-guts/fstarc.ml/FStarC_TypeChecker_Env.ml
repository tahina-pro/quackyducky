...
let (print_effects_graph : env -> Prims.string) =
  fun env1 ->
    ...
    let pbinds = FStarC_SMap.smap_create (Prims.of_int (10)) in
    let lifts = FStarC_SMap.smap_create (Prims.of_int (20)) in
    let psubcomps = FStarC_SMap.smap_create (Prims.of_int (10)) in
    FStarC_List.iter
      (fun uu___1 ->
         match uu___1 with
         | { msource = src; mtarget = tgt; mlift = uu___2; mpath = path;_} ->
             ...
             let m =
               let uu___3 = FStarC_SMap.smap_try_find lifts key in
               match uu___3 with
               | FStar_Pervasives_Native.None ->
                   let m1 = FStarC_SMap.smap_create (Prims.of_int (10)) in
                   (FStarC_SMap.smap_add lifts key m1; m1)
               | FStar_Pervasives_Native.Some m1 -> m1 in
             let uu___3 =
               let uu___4 = eff_name tgt in
               FStarC_SMap.smap_try_find m uu___4 in
             (match uu___3 with
              | FStar_Pervasives_Native.Some uu___4 -> ()
              | FStar_Pervasives_Native.None ->
                  let uu___4 = eff_name tgt in
                  let uu___5 = path_str path in
                  FStarC_SMap.smap_add m uu___4 uu___5)) (env1.effects).order;
    FStarC_List.iter
      (fun uu___2 ->
         match uu___2 with
         | (m, n, p, uu___3) ->
             ...
             FStarC_SMap.smap_add pbinds key "")
    ...
    FStarC_List.iter
      (fun uu___3 ->
         ...
         | (m, n, uu___4, uu___5) ->
             ...
             FStarC_SMap.smap_add psubcomps key "")
      (env1.effects).polymonadic_subcomps;
    (let uu___3 =
       let uu___4 =
         FStarC_SMap.smap_fold lifts
           (fun src ->
              fun m ->
                fun s ->
                  FStarC_SMap.smap_fold m
                    (fun tgt ->
                       fun path ->
                         fun s1 ->
                           let uu___5 =
     ...
     let uu___5 =
       let uu___6 =
         FStarC_SMap.smap_fold psubcomps
           (fun k ->
              fun uu___7 ->
                fun s ->
                  let uu___8 =

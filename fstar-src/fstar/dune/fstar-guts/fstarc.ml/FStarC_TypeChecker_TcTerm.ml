                                     ...
                                     let uu___10 =
                                       let uu___11 =
                                         FStarC_Syntax_Util.comp_effect_name
                                           c in
                                       FStarC_Class_Show.show
                                         FStarC_Ident.showable_lident uu___11 in
                                     let uu___11 =
                                       FStarC_Class_Show.show
    ...
    fun e ->
      ...
      | FStarC_Syntax_Syntax.Tm_fvar fv ->
          ...
          (match uu___ with
           | ((us, t), range) ->
               let fv1 = FStarC_Syntax_Syntax.set_range_of_fv fv range in
               (maybe_warn_on_use env1 fv1;
                (let uu___3 = FStarC_Effect.op_Bang dbg_Range in
                 if uu___3
                 then
                   let uu___4 =
                   ...
                   let uu___5 =
                     FStarC_Range_Ops.string_of_range
                       e.FStarC_Syntax_Syntax.pos in
                   let uu___6 = FStarC_Range_Ops.string_of_range range in
                   let uu___7 = FStarC_Range_Ops.string_of_use_range range in
                   let uu___8 =
                     FStarC_Class_Show.show FStarC_Syntax_Print.showable_term
                       t in
                   FStarC_Util.print5
          ...
          (match uu___ with
           | (x1, phi1) ->
               ...
               (match uu___1 with
                | (env2, uu___2) ->
                    let uu___3 =
                      let uu___4 = FStarC_List.hd x1 in tc_binder env2 uu___4 in
                    (match uu___3 with
                     | (x2, env3, f1, u) ->
      ...
      | uu___ ->
          let uu___1 =
            ...
            let uu___3 =
              FStarC_Class_Tagged.tag_of FStarC_Syntax_Syntax.tagged_term top in
            FStarC_Util.format2 "Unexpected value: %s (%s)" uu___2 uu___3 in
          failwith uu___1
and (tc_constant :
  FStarC_TypeChecker_Env.env ->
    FStarC_Range_Type.range ->
                              ...
                              ((let uu___7 = FStarC_Debug.high () in
                                ...
                                then
                                  let uu___8 =
                                    FStarC_Class_Show.show
                                      FStarC_Syntax_Print.showable_bv hd in
                                  FStarC_Util.print1 "Checking binder %s\n"
                                    uu___8
                                else ());
                               (let uu___7 =
                       ...
                       let r1 =
                         ...
                         | ((t, uu___2), uu___3, uu___4)::uu___5 ->
                             ...
                             let uu___7 =
                               ...
                               FStarC_Range_Ops.union_rng uu___8 uu___9 in
                             FStarC_Range_Type.range_of_rng uu___6 uu___7 in
                     ...
                     | (head_p, args_p) ->
                         ...
                         then
                           ...
                           (let uu___11 =
                              ...
                              FStarC_Util.format2 "Head mismatch %s vs %s"
                                uu___12 uu___13 in
                            fail1 uu___11))
                | uu___4 ->
                    let uu___5 =
                 ...
                 | (env2, uu___3) ->
                     ...
                     ((let uu___5 = FStarC_Effect.op_Bang dbg_UniverseOf in
                       ...
                       then
                         ...
                         FStarC_Util.print2 "%s: About to type-check %s\n"
                           uu___6 uu___7
                       else ());

...
docker save evercbor-ccs2025-deps | gzip > evercbor-ccs2025-deps.tar.gz
docker save evercbor-ccs2025-build | gzip > evercbor-ccs2025-build.tar.gz
docker save evercbor-ccs2025-test | gzip > evercbor-ccs2025-test.tar.gz

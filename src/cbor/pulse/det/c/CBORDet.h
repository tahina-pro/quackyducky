...
typedef struct CBOR_Spec_RawInt_raw_uint64_s
{
  uint8_t size;
  uint64_t value;
}
...
{
  CBOR_Spec_RawInt_raw_uint64 cbor_serialized_header;
...
{
  CBOR_Spec_RawInt_raw_uint64 cbor_tagged_tag;
...
typedef struct Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_raw_s
{
  cbor_raw *elt;
  size_t len;
}
...
typedef struct cbor_array_s
{
  ...
  Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_raw cbor_array_ptr;
}
cbor_array;

typedef struct cbor_map_entry_s cbor_map_entry;

typedef struct Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_map_entry_s
{
  cbor_map_entry *elt;
  size_t len;
}
...
typedef struct cbor_map_s
{
  ...
  Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_map_entry cbor_map_ptr;
}
cbor_map;
...
typedef struct cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw_s
...
typedef uint8_t cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw_tags;

typedef struct cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw_s
{
  cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw_tags tag;
  union {
    Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_raw case_CBOR_Raw_Iterator_Slice;
...
typedef struct cbor_raw_iterator__CBOR_Pulse_Type_cbor_map_entry_s
...
typedef struct cbor_raw_iterator__CBOR_Pulse_Type_cbor_map_entry_s
{
  cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw_tags tag;
  union {
    Pulse_Lib_Slice_slice__CBOR_Pulse_Type_cbor_map_entry case_CBOR_Raw_Iterator_Slice;
    Pulse_Lib_Slice_slice__uint8_t case_CBOR_Raw_Iterator_Serialized;
  }
  ;
}
...
typedef cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw cbor_array_iterator;

typedef cbor_raw_iterator__CBOR_Pulse_Type_cbor_map_entry cbor_map_iterator;

typedef cbor_raw cbor_det_t;

typedef cbor_map_entry cbor_det_map_entry_t;

typedef cbor_raw_iterator__CBOR_Pulse_Type_cbor_raw cbor_det_array_iterator_t;

typedef cbor_raw_iterator__CBOR_Pulse_Type_cbor_map_entry cbor_det_map_iterator_t;
...
typedef struct FStar_Pervasives_Native_option__CBOR_Pulse_Type_cbor_raw_s
{
  FStar_Pervasives_Native_option__LowParse_Pulse_Base_with_perm_Pulse_Lib_Slice_slice_CBOR_Pulse_Type_cbor_raw_tags
  tag;
  cbor_raw v;
...
cbor_map_entry
cbor_det_map_iterator_next(cbor_raw_iterator__CBOR_Pulse_Type_cbor_map_entry *x);

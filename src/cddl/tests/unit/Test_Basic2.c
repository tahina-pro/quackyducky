...
int main()
{
    ...
    FStar_Pervasives_Native_option__K___Basic2_map18_Pulse_Lib_Slice_slice__uint8_t
    ...
    FStar_Pervasives_Native_option__K___Basic2_map42_Pulse_Lib_Slice_slice__uint8_t

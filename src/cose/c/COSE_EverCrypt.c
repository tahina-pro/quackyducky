...
static Pulse_Lib_Slice_slice__K___COSE_Format_evercddl_label_COSE_Format_values
...
)
{
  return
    (
      (Pulse_Lib_Slice_slice__K___COSE_Format_evercddl_label_COSE_Format_values){
        .elt = a,
        .len = alen
      }
    );

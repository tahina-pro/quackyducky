...
typedef struct Pulse_Lib_Slice_slice__K___COSE_Format_evercddl_label_COSE_Format_values_s
...
typedef struct K___COSE_Format_bstr_COSE_Format_bstr_s K___COSE_Format_bstr_COSE_Format_bstr;
...
typedef struct COSE_Format_aux_env29_type_1_ugly_s COSE_Format_aux_env29_type_1_ugly;

typedef struct COSE_Format_evercddl_label_s COSE_Format_evercddl_label;

typedef struct COSE_Format_evercddl_label_ugly_s COSE_Format_evercddl_label_ugly;
...
typedef struct
FStar_Pervasives_either__CDDL_Pulse_Types_slice__K___COSE_Format_evercddl_label_COSE_Format_values_CDDL_Pulse_Parse_MapGroup_map_iterator_t__CBOR_Pulse_API_Det_Type_cbor_det_t_CBOR_Pulse_API_Det_Type_cbor_det_map_entry_t_CBOR_Pulse_API_Det_Type_cbor_det_map_iterator_t_COSE_Format_evercddl_label_COSE_Format_values_s
...
typedef struct
FStar_Pervasives_Native_option__K___COSE_Format_evercddl_label_Pulse_Lib_Slice_slice__uint8_t_s
...
FStar_Pervasives_either__CDDL_Pulse_Types_slice__K___COSE_Format_evercddl_label_COSE_Format_values_CDDL_Pulse_Parse_MapGroup_map_iterator_t__CBOR_Pulse_API_Det_Type_cbor_det_t_CBOR_Pulse_API_Det_Type_cbor_det_map_entry_t_CBOR_Pulse_API_Det_Type_cbor_det_map_iterator_t_COSE_Format_evercddl_label_COSE_Format_values_s
{
  COSE_Format_evercddl_int_ugly_tags tag;
  union {
    Pulse_Lib_Slice_slice__K___COSE_Format_evercddl_label_COSE_Format_values case_Inl;
    CDDL_Pulse_Parse_MapGroup_map_iterator_t__CBOR_Pulse_API_Det_Type_cbor_det_t_CBOR_Pulse_API_Det_Type_cbor_det_map_entry_t_CBOR_Pulse_API_Det_Type_cbor_det_map_iterator_t_COSE_Format_evercddl_label_COSE_Format_values
    case_Inr;
  }
  ;

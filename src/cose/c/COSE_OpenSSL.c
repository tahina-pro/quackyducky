...
bstr COSE_OpenSSL_sign1(EVP_PKEY *signing_key,
        ...
        bstr aad, bstr payload) {
    protected_headers.intkey1 = (FStar_Pervasives_Native_option__COSE_Format_label_ugly) {
...
bstr COSE_OpenSSL_verify1(EVP_PKEY *signing_key, bstr aad, bstr msg) {
    FStar_Pervasives_Native_option__K___COSE_Format_cose_sign1_tagged_Pulse_Lib_Slice_slice__uint8_t parsed_msg =

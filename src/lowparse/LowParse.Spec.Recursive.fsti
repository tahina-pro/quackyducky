...
let parse_recursive_payload
  ...
  (h: p.header)
: Tot (tot_parser (parse_recursive_payload_kind p.parse_header_kind) (parse_recursive_payload_t p.t p.header p.count h))
= tot_weaken (parse_recursive_payload_kind p.parse_header_kind) (tot_parse_nlist (p.count h) ih)
...
let spec_parse_recursive_payload
  ...
  (h: p.header)
: Tot (parser (parse_recursive_payload_kind p.parse_header_kind) (parse_recursive_payload_t p.t p.header p.count h))
= weaken (parse_recursive_payload_kind p.parse_header_kind) (parse_nlist (p.count h) ih)
